...
def load_models():
    ...
    with open("models/publisher_model.pkl", "rb") as f:
...
# Function to save/update user's rating for a specific book
...
# Function to retrieve all book ratings given by the user
...
# Function to delete a user's rating for a specific book
...
# Publisher based recommendation - predicts publisher for a given book title and recommends other books from the same publisher
...
# Content Based Recommendation - finds books similar to the given book title based on TF-IDF features using KNN
...
# COllaborative Filtering recommendation technique - finds books liked by similar users 
