...
# ---------- Pages ----------
def home_page():
    set_bg_image("images/home_img.jpg")
    st.title("Welcome to SmartShelf: Your Personal Book Recommender")
    st.markdown("""
    #### Discover your next favorite book effortlessly!
    - Log in or Sign up to explore personalized recommendations.
    - Our system adapts to your reading habits.
    - Search books, rate them, and get smart suggestions.
    """)
...
def recommendation_page():
    st.title("SmartShelf Book Recommender")
